...
export class StringFilter extends _StringFilter {
  @ApiProperty({ required: false, type: () => _StringFilter })
  not?: _StringFilter;
}
...
export class NumberFilter extends _NumberFilter {
  @ApiProperty({ required: false, type: () => _NumberFilter })
  not?: _NumberFilter;
}

export class _DateFilter {
  @ApiProperty({ required: false, type: 'string', format: 'datetime' })
  equals?: string;
  @ApiProperty({ required: false, type: 'string', format: 'datetime' })
  gt?: string;
  @ApiProperty({ required: false, type: 'string', format: 'datetime' })
...
export class ArrayStringFilter extends _ArrayStringFilter {
  @ApiProperty({ required: false, type: () => _ArrayStringFilter })
  not?: _ArrayStringFilter;
}
...
export class ArrayNumberFilter extends _ArrayNumberFilter {
  @ApiProperty({ required: false, type: () => _ArrayNumberFilter })
  not?: _ArrayNumberFilter;
}
...
export class CategorySelectDto extends CategoryOwnSelectDto {
  @ApiProperty({
    required: false,
    type: () => CategoryOwnSelectDto,
    description: 'optional',
  })
  parent?: CategoryOwnSelectDto;
  @ApiProperty({
    required: false,
    type: () => CategoryOwnSelectDto,
    description: 'optional',
  })
  children?: CategoryOwnSelectDto;
  @ApiProperty({
    required: false,
    type: () => TodoOwnSelectDto,
    description: 'optional',
  })
  todos?: TodoOwnSelectDto;
}
